...
| M6.6 Task 1 | Contract `AI_CLIP` và provenance typed; role/ownership một scene; duration M6.5 đúng 120/180/240 frame; semantic/decorative policy; rights bắt buộc; referenced decorative clip vẫn kiểm byte/hash; legacy giữ nguyên. | Implemented; awaiting C2C review | 98 focused tests; 94 nearest regressions; deterministic schema export; Ruff; `git diff --check` | `feat: define reviewed AI clip assets` |
