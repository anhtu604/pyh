...
| M1.2 | Main-path graph v2 có precondition | complete | `python -m pytest -q --basetemp=.task2-fix1-pytest` (148 passed); `python -m ruff check src tests tools`; `git diff --check` | `feat: add preconditioned v2 state graph` |
