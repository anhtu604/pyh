...
| M1.2 | Main-path graph v2 có precondition | complete | `python -m pytest -q --basetemp=.task2-pytest-escalated` (138 passed); `python -m ruff check src tests tools`; `git diff --check` | `feat: add preconditioned v2 state graph` |
