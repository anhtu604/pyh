...
| M6.4 design | Đặc tả hook ở frame 0 không intro; câu kết thuộc script và storyboard trước duyệt; brand asset khai báo; v2 không giới hạn tổng thời lượng, audio phải khớp timeline; v1 giữ nguyên. Chưa triển khai. | spec drafted; waiting for user review | C2C planning review; spec self-review; 22 contract tests; Ruff; `git diff --check` | `docs: design M6.4 hook and reviewed outro` |
