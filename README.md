...
| M6.6 Task 3 | Medical gate phục hồi intent AI hợp lệ, kiểm ownership/citation/quyền và đưa mọi AI clip kể cả decorative vào review hash; packet hiển thị classification, provider/model/duration/hash prefix/quyền mà không lộ prompt hoặc runtime secret. | Implemented; awaiting C2C review | 49 gate/packet/authoring tests; Ruff; `git diff --check` | pending |
