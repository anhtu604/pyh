...
| M6.5 design | Ngân sách visual tính theo frame storyboard đã duyệt; ba nhóm loại trừ nhau, override nằm trong medical hash; chart dùng SVG khai báo, AI production chờ M6.6. | Designed; chờ C2C review trước implementation | Spec/plan review; Ruff; `git diff --check` | `docs: design M6.5 visual budget QA` |
