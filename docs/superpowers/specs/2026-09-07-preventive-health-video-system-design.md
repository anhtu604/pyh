...
## 9. Kịch bản và storyboard

Khung mặc định cho 45–90 giây:

1. Hook: nêu hiểu nhầm hoặc quyết định thực tế.
2. Position: bác sĩ nói rõ quan điểm trong một câu.
3. Evidence: hai hoặc ba mảnh bằng chứng mạnh nhất.
4. Nuance: giới hạn, ngoại lệ hoặc nhóm không áp dụng.
5. Action: hành động phòng bệnh cụ thể, an toàn.
6. Close: nhắc đây là thông tin chung và hiển thị ký hiệu nguồn.

Mỗi cảnh chứa thời lượng, lời thoại, chữ trên màn hình, hành động hình ảnh, claim ID, source marker và loại asset. Bộ kiểm tra ước lượng tốc độ đọc tiếng Việt, độ dài subtitle, vùng an toàn TikTok, mật độ thuật ngữ, số claim và tổng thời lượng. Bác sĩ có thể sửa văn bản trực tiếp; lần chạy sau chỉ tái tạo audio và các cảnh bị ảnh hưởng.
